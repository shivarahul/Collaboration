app.controller("forumController", function($scope, $http, $location) {
	function fetchAllForum() {
		...
		$http.get("http://localhost:8181/socialcollaborationbackend/getAllForums")
	...
	$scope.insertForum = function() {
		...
		$http.post('http://localhost:8181/socialcollaborationbackend/insertForum',
	...
	$scope.deleteForum=function(forumId)
	{
		...
		$http.get("http://localhost:8181/socialcollaborationbackend/deleteForum/"+forumId)
